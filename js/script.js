...
function emailInput() {
    ...
    if (emailregex.test(email)) {
        ...
        $('label[for = "mail"]').before('<label><font color ="red">Please Enter a Valid E-mail</font></label>');
        return false;
    }
...
function nameInput() {
    ...
    if (nameregex.test(name)) {
        ...
        $('label[for = "name"]').before('<label><font color ="red">Please Enter a Name</font></label>');
...
function ccInput() {
    ...
    if (ccregex.test(ccVal)) {
        ...
        $('label[for = "cc-num"]').before('<label><font color ="red">Card Number Must Be Between 13-16 Digits</font></label>');
        return false;
    }
}
...
function cvvInput() {
    ...
    if (CVVregex.test(CVVval)) {
        ...
        $('label[for = "cvv"]').before('<label><font color ="red">Please Enter a 3 Digit CVV Number</font></label>');
        return false;
    }
}
...
function zipInput() {
    ...
    if (zipregex.test(zipVal)) {
        ...
        $('label[for = "zip"]').before('<label><font color ="red">Please Enter a 5 Digit Zip Code</font></label>');
        return false;
